...
**/
    ...
    public com.codename1.ui.TextArea findTextUbicacion(Component root) {
        return (com.codename1.ui.TextArea)findByName("TextUbicacion", root);
    }

    public com.codename1.ui.TextArea findTextUbicacion() {
        com.codename1.ui.TextArea cmp = (com.codename1.ui.TextArea)findByName("TextUbicacion", Display.getInstance().getCurrent());
        if(cmp == null && aboutToShowThisContainer != null) {
            cmp = (com.codename1.ui.TextArea)findByName("TextUbicacion", aboutToShowThisContainer);
        }
        return cmp;
    }
    ...
    public static final int COMMAND_MainInicioSesion = 2;
    public static final int COMMAND_MainBuscarCoche = 3;
    public static final int COMMAND_InicioSesionCancel = 6;
    public static final int COMMAND_MainMostrarSolicitudes = 7;
    public static final int COMMAND_MainIniciarSesiN = 4;
    public static final int COMMAND_MainRegistrate = 8;
    public static final int COMMAND_MainRegistro = 1;

    protected boolean onMainInicioSesion() {
        return false;
    }
    ...
    protected boolean onInicioSesionCancel() {
        return false;
    }

    protected boolean onMainMostrarSolicitudes() {
        return false;
    }

    protected boolean onMainIniciarSesiN() {
        return false;
    }

    protected boolean onMainRegistrate() {
        return false;
    }
    ...
    protected void processCommand(ActionEvent ev, Command cmd) {
        switch(cmd.getId()) {
            case COMMAND_MainInicioSesion:
                if(onMainInicioSesion()) {
                    ev.consume();
                    return;
                }
                break;
            ...
            case COMMAND_InicioSesionCancel:
                if(onInicioSesionCancel()) {
                    ev.consume();
                    return;
                }
                break;

            case COMMAND_MainMostrarSolicitudes:
                if(onMainMostrarSolicitudes()) {
                    ev.consume();
                    return;
                }
                break;

            case COMMAND_MainIniciarSesiN:
                if(onMainIniciarSesiN()) {
                    ev.consume();
                    return;
                }
                break;

            case COMMAND_MainRegistrate:
                if(onMainRegistrate()) {
                    ev.consume();
                    return;
                }
    ...
    protected void exitForm(Form f) {
        if("Recuperar clave".equals(f.getName())) {
            exitRecuperarClave(f);
            aboutToShowThisContainer = null;
            return;
        }

        if("Mostrar solicitudes".equals(f.getName())) {
            exitMostrarSolicitudes(f);
            aboutToShowThisContainer = null;
            return;
        }
    ...
    protected void exitRecuperarClave(Form f) {
    }


    protected void exitMostrarSolicitudes(Form f) {
    }
    ...
    aboutToShowThisContainer = f;
        if("Recuperar clave".equals(f.getName())) {
            beforeRecuperarClave(f);
            aboutToShowThisContainer = null;
            return;
        }

        if("Mostrar solicitudes".equals(f.getName())) {
            beforeMostrarSolicitudes(f);
            aboutToShowThisContainer = null;
            return;
        }
    ...
    protected void beforeRecuperarClave(Form f) {
    }


    protected void beforeMostrarSolicitudes(Form f) {
    }
    ...
    protected void beforeShowContainer(Container c) {
        ...
        if("Recuperar clave".equals(c.getName())) {
            beforeContainerRecuperarClave(c);
            aboutToShowThisContainer = null;
            return;
        }

        if("Mostrar solicitudes".equals(c.getName())) {
            beforeContainerMostrarSolicitudes(c);
            aboutToShowThisContainer = null;
            return;
        }
    ...
    protected void beforeContainerRecuperarClave(Container c) {
    }


    protected void beforeContainerMostrarSolicitudes(Container c) {
    }
    ...
    protected void postShow(Form f) {
        if("Recuperar clave".equals(f.getName())) {
            postRecuperarClave(f);
            aboutToShowThisContainer = null;
            return;
        }

        if("Mostrar solicitudes".equals(f.getName())) {
            postMostrarSolicitudes(f);
            aboutToShowThisContainer = null;
            return;
        }
    ...
    protected void postRecuperarClave(Form f) {
    }


    protected void postMostrarSolicitudes(Form f) {
    }
    ...
    protected void postShowContainer(Container c) {
        if("Recuperar clave".equals(c.getName())) {
            postContainerRecuperarClave(c);
            aboutToShowThisContainer = null;
            return;
        }

        if("Mostrar solicitudes".equals(c.getName())) {
            postContainerMostrarSolicitudes(c);
            aboutToShowThisContainer = null;
            return;
        }
    ...
    protected void postContainerRecuperarClave(Container c) {
    }


    protected void postContainerMostrarSolicitudes(Container c) {
    }
    ...
    protected void onCreateRoot(String rootName) {
        if("Recuperar clave".equals(rootName)) {
            onCreateRecuperarClave();
            aboutToShowThisContainer = null;
            return;
        }

        if("Mostrar solicitudes".equals(rootName)) {
            onCreateMostrarSolicitudes();
            aboutToShowThisContainer = null;
            return;
        }
    ...
    protected void onCreateRecuperarClave() {
    }


    protected void onCreateMostrarSolicitudes() {
    }
    ...
    protected Hashtable getFormState(Form f) {
        ...
        if("Recuperar clave".equals(f.getName())) {
            getStateRecuperarClave(f, h);
            aboutToShowThisContainer = null;
            return h;
        }

        if("Mostrar solicitudes".equals(f.getName())) {
            getStateMostrarSolicitudes(f, h);
            aboutToShowThisContainer = null;
            return h;
        }
    ...
    protected void getStateRecuperarClave(Form f, Hashtable h) {
    }


    protected void getStateMostrarSolicitudes(Form f, Hashtable h) {
    }
    ...
    protected void setFormState(Form f, Hashtable state) {
        ...
        if("Recuperar clave".equals(f.getName())) {
            setStateRecuperarClave(f, state);
            aboutToShowThisContainer = null;
            return;
        }

        if("Mostrar solicitudes".equals(f.getName())) {
            setStateMostrarSolicitudes(f, state);
            aboutToShowThisContainer = null;
            return;
        }
    ...
    protected void setStateRecuperarClave(Form f, Hashtable state) {
    }


    protected void setStateMostrarSolicitudes(Form f, Hashtable state) {
    }
    ...
    protected void handleComponentAction(Component c, ActionEvent event) {
        ...
        if(rootContainerName.equals("Registro")) {
            ...
            if("TextUbicacion".equals(c.getName())) {
                onRegistro_TextUbicacionAction(c, event);
                return;
            }
      ...
      protected void onRegistro_TextUbicacionAction(Component c, ActionEvent event) {
      }
